...
url = "https://services1.arcgis.com/CgOSc11uky3egK6O/arcgis/rest/services/Erie_County_Parcels/FeatureServer/0/query"
params = {
    "f": "json",
    "where": "1=1",
    "outFields": "*",
...
if all_features:
    ...
    with open('Erie_County_Parcels.csv', 'w', newline='') as csvfile:
