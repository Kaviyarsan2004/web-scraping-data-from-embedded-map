...
url = "https://services3.arcgis.com/F5762GA30C3SyZFy/ArcGIS/rest/services/CCBT24/FeatureServer/12/query"
params = {
    "f": "json",
    "where": "1=1",
    "outFields": "*",
...
if all_features:
    ...
    with open('Columbia_County_Parcels.csv', 'w', newline='') as csvfile:
