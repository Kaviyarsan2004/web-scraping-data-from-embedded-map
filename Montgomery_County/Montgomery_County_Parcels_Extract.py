...
url = "https://services5.arcgis.com/WcotYUBrYwlGLzUr/ArcGIS/rest/services/Parcels/FeatureServer/0/query"
params = {
    "f": "json",
    "where": "1=1",
    "outFields": "*",
...
if all_features:
    ...
    with open('Montgomery_County_Parcels.csv', 'w', newline='') as csvfile:
