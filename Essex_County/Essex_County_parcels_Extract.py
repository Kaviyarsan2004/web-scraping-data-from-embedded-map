...
url = "https://services6.arcgis.com/YMCiEBhA0TNgGZ2c/ArcGIS/rest/services/Parcels2023_view/FeatureServer/5/query"
params = {
    "f": "json",
    "where": "1=1",
    "outFields": "*",
...
if all_features:
    ...
    with open('Essex_County_Parcels.csv', 'w', newline='') as csvfile:
